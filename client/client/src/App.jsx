...
useEffect(() => {
  ...
  return (
    <div className="app-container">
      <div className="left-pane">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', margin: '0 70px ' }}>
          <h1 style={{fontSize: "clamp(5px, 5vw, 50px)"}}>🎵 얼굴 인식 기반 노래 추천 🎵</h1>
  ...
  onResultMeta={({ emotion, age, gender }) => {
